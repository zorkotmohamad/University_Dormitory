...
public class LeavedStudents extends javax.swing.JFrame {
    ...
    public LeavedStudents() {
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select * from students where status='Leaved'");
            while(rs.next()){
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(13, 70, 670, 416));
