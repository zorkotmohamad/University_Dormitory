...
public class AllStudentsLiving extends javax.swing.JFrame {
    ...
    public AllStudentsLiving() {
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select * from students where status='Living'");
            while(rs.next()){
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Mobile Number", "Father Name", "Mother Name", "Email", "Address", "Department", "Room Number"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(17, 75, 659, 390));
